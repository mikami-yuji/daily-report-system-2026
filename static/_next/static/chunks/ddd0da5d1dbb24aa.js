...
to {
  ...
  animation: ${G} 0.3s 0.12s cubic-bezier(0.175, 0.885, 0.32, 1.275)
    forwards;
`,Z=({toast:e})=>{let{icon:t,type:r,iconTheme:s}=e;return void 0!==t?"string"==typeof t?i.createElement(B,null,t):t:"blank"===r?null:i.createElement(Q,null,i.createElement(N,{...s}),"loading"!==r&&i.createElement(H,null,"error"===r?i.createElement(q,{...s}):i.createElement(_,{...s})))},W=g("div")`
  display: flex;
  align-items: center;
  background: #fff;
  color: #363636;
